...
TTPS=(
  "T1059.004:T1059_004_step-01.sh:Endpoint - spawn interactive shell from web service"
  "T1071.001:T1071_001_step-02.sh:Endpoint - HTTP beacon callback to known-bad test domain"
  "T1572:T1572_step-03.sh:DNS tunneling exfil pattern"
  "T1105:T1105_step-04.sh:Ingress tool transfer (download simulated second-stage)"
)
...
cleanup() {
  log "=== cleanup ==="
  rm -f /tmp/cortexsim_* /tmp/sim_mp_001_* 2>/dev/null || true
