...
TTPS=(
  "T1005:T1005_step-01.sh:Collect sensitive-looking data from endpoint"
  "T1074.001:T1074_001_step-02.sh:Stage data in compressed format"
  "T1048.003:T1048_003_step-03.sh:Exfiltrate staged data over DNS tunnel"
  "T1048:T1048_step-04.sh:Alternative exfil - HTTPS POST to known-bad endpoint"
)
...
cleanup() {
  log "=== cleanup ==="
  rm -f /tmp/cortexsim_* /tmp/sim_mp_003_* 2>/dev/null || true
