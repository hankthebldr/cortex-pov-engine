...
VERDICT = {
    ...
    "TC-AGTX-08":  ("BUILDABLE_ASSERTION", "Agent decision transparency is queryable on xsiam_incidents — actor type, action, approval state. AUT-AEPS-002/chk-03 is the precedent."),
    ...
    "TC-APB-05":   ("BUILDABLE_ASSERTION", "Guardrail enforcement is queryable: high-risk actions carrying an approval decision. AUT-AEPS-002/chk-03 already does exactly this."),
