...
- **detection** — detection-corpus validator (**330 pass / 0 warn / 0 fail**) + deterministic export regeneration check (`sha256sum -c`, SKELETON=0).
