...
| `scripts/validate.py` | The canonical validator — the single source of truth for what "valid" means. CI, the engine, and contributors all run it. | Only when changing what "valid" means (and update this RUNBOOK + README to match). |
